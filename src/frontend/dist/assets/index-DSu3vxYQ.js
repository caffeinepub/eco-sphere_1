...
const APARTMENT_DETAILS = [
  ...
  },
  {
    ...
    emoji: "🏡",
    shortDesc: "Low-rise villa clusters nestled within community gardens — the perfect blend of private comfort and shared green space.",
    longDesc: "The EcoVilla District offers a quieter, more intimate way to live sustainably. Low-rise villas are arranged in clusters around shared community gardens where residents grow vegetables, host outdoor meals, and gather for events. Each villa is built from recycled timber and natural stone, insulated with eco-friendly materials, and heated or cooled entirely by geothermal systems. Car-free pedestrian pathways connect every home to parks, schools, and transit hubs.",
    highlights: [
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            width: `${pct}%`,
            background: "linear-gradient(90deg, oklch(0.52 0.18 148), oklch(0.72 0.22 88), oklch(0.52 0.18 148))",
...
function ApartmentModal({ apt, onClose }) {
  reactExports.useEffect(() => {
    if (!apt) return;
    const onKey = (e) => {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: "linear-gradient(135deg, rgba(30,80,40,0.5), rgba(20,30,60,0.5))",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-8 py-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: apt.highlights.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
              ...
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, oklch(0.52 0.18 148), oklch(0.45 0.20 165))",
...
function Navbar() {
  ...
  const [activeId, setActiveId] = reactExports.useState("home");
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      "nav",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `hidden md:flex items-center justify-between gap-1 px-4 py-2 transition-all duration-500 ${scrolled ? "navbar-scrolled" : "navbar-default"}`,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0.5", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    ...
                    style: {
                      color: activeId === link.id ? "white" : "rgba(255,255,255,0.65)",
                      background: activeId === link.id ? "rgba(80,200,100,0.18)" : "transparent",
                      border: activeId === link.id ? "1px solid rgba(100,220,120,0.35)" : "1px solid transparent"
                    },
                    children: link.label
                  },
                  link.id
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `md:hidden flex items-center justify-between w-full px-4 py-2 transition-all duration-500 ${scrolled ? "navbar-scrolled" : "navbar-default"}`,
    ...
    menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 grid grid-cols-2 gap-1", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => scrollTo(link.id),
            ...
            style: {
              color: activeId === link.id ? "oklch(0.85 0.18 148)" : "rgba(255,255,255,0.7)",
              background: activeId === link.id ? "rgba(80,200,100,0.12)" : "transparent"
            },
            children: link.label
          },
          link.id
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "url('/assets/generated/hero-city.dim_1400x700.jpg')"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(135deg, rgba(10,25,60,0.88) 0%, rgba(5,40,20,0.80) 50%, rgba(10,25,60,0.88) 100%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              background: "radial-gradient(circle, oklch(0.60 0.22 148 / 0.18) 0%, transparent 70%)",
              zIndex: 2
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-blob hero-blob-1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-blob hero-blob-2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-blob hero-blob-3" }),
        LEAVES.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "hero-leaf",
            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-4 max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-green-400 animate-pulse inline-block" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "h1",
            {
              ...
              children: [
                "ECO ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shimmer-text", children: "SPHERE" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Building a Better World Since 2026"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-cta flex flex-col sm:flex-row gap-4 justify-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: () => {
                  var _a2;
                  return (_a2 = document.getElementById("map")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                },
                "data-ocid": "hero.secondary_button",
                children: "🗺️ View City Map"
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs tracking-widest uppercase", children: "Scroll" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-0.5 h-8 bg-white/40 relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-1/2 bg-white/80 absolute top-0 animate-bounce" }) })
        ] })
      ]
    }
  );
...
function LogoCloud() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: "text-xs font-semibold uppercase tracking-widest mb-6",
            style: { color: "oklch(0.50 0.05 200)" },
            children: "Powered by world-class sustainability technology"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center items-center gap-4", children: LOGO_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
...
function AboutSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(180deg, oklch(0.97 0.01 148) 0%, oklch(0.93 0.03 148) 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto relative", ref, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Eco Sphere is a pioneering sustainable smart city designed from the ground up for harmony between humanity and nature. Every system \\u2014 energy, housing, mobility, and culture \\u2014 is engineered for a zero-carbon future."
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-8", children: FEATURES.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            TiltCard,
            {
...
function ApartmentsSection() {
  ...
  const [selectedApt, setSelectedApt] = reactExports.useState(null);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        className: "py-24 px-4 relative overflow-hidden",
        style: {
          background: "linear-gradient(135deg, oklch(0.10 0.04 200) 0%, oklch(0.13 0.06 180) 50%, oklch(0.10 0.04 200) 100%)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto relative", ref, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  ...
                  children: "Sustainable Apartments"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Every home in Eco Sphere is a statement in sustainable living \\u2014 beautiful, efficient, and deeply connected to the natural world."
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal rounded-3xl overflow-hidden mb-12 shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: APARTMENTS.map((apt, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TiltCard,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg mb-2 text-white", children: apt.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ApartmentModal, { apt: selectedApt, onClose: () => setSelectedApt(null) })
  ] });
}
function useCounterAnimation(target, suffix2, inView) {
  const [display, setDisplay] = reactExports.useState(`0${suffix2}`);
  reactExports.useEffect(() => {
    if (!inView) return;
    let start = 0;
    const duration = 2e3;
    ...
    const timer = setInterval(() => {
      start += increment;
      if (start >= target) {
        setDisplay(`${target.toLocaleString()}${suffix2}`);
        clearInterval(timer);
      } else {
        setDisplay(`${Math.floor(start).toLocaleString()}${suffix2}`);
      }
    }, step);
    return () => clearInterval(timer);
  }, [inView, target, suffix2]);
  return display;
}
const ENERGY_STATS = [
...
function EnergySection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      className: "py-24 px-4 relative overflow-hidden",
      style: {
        background: "linear-gradient(180deg, oklch(0.97 0.01 148) 0%, oklch(0.93 0.04 140) 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto relative", ref, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: { color: "oklch(0.40 0.05 200)" },
                  children: "Eco Sphere runs entirely on clean energy. Our massive solar arrays capture the sun\\u2019s power while 40 wind turbines harness coastal breezes. Together they power every home, vehicle, and business \\u2014 with surplus stored for a rainy day."
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4 reveal", children: ENERGY_STATS.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TiltCard,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal rounded-3xl overflow-hidden shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
...
function ParksSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      className: "py-24 px-4 relative overflow-hidden",
      style: {
        background: "linear-gradient(135deg, oklch(0.18 0.08 148) 0%, oklch(0.14 0.06 180) 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto relative", ref, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal rounded-3xl overflow-hidden shadow-2xl order-last lg:order-first", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  ...
                  style: { fontSize: "clamp(2rem, 5vw, 3.5rem)" },
                  children: "Green Parks & Community"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Nature is not an afterthought in Eco Sphere \\u2014 it\\u2019s the foundation. One urban park weaves through the city like a living network, connecting residents to biodiversity zones, community gardens, and tranquil wetlands."
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 reveal", children: PARK_BADGES.map((badge, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
...
function VideoSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(180deg, oklch(0.93 0.04 140) 0%, oklch(0.97 0.01 148) 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", ref, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 reveal", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "text-lg max-w-2xl mx-auto",
              style: { color: "oklch(0.40 0.05 200)" },
              children: "Watch how Eco Sphere brings together sustainability, community, and innovation in one thriving smart city."
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const HOTSPOTS = [
  {
    ...
    description: "Eco Sphere's solar power plant spans 12 acres with 2 large photovoltaic farms generating clean electricity for every home and building in the city.",
    details: [
      "2 solar panel farms",
  ...
  },
  {
    ...
    description: "A lush 35-acre urban park at the heart of Eco Sphere, featuring walking trails, community gardens, natural wetlands, and 400+ native plant species.",
    details: [
  ...
  },
  {
    ...
    description: "A natural freshwater lake that acts as Eco Sphere's water reservoir. It supports biodiversity, provides recreational activities, and feeds the city's clean water system.",
    details: [
  ...
  },
  {
    ...
    description: "A world-class eco-friendly sports complex with solar-lit courts, natural grass fields, and zero-waste facilities promoting active and healthy community living.",
    details: [
  ...
  },
  {
    ...
    description: "The community hub of Eco Sphere — home to co-working spaces, event halls, a rooftop café, and collaborative workshops for residents to gather and innovate.",
    details: [
      "Co-working spaces",
      "Rooftop café",
  ...
  },
  {
    ...
    description: "A state-of-the-art green hospital powered entirely by renewables, featuring energy-efficient wards, a healing garden, and advanced telemedicine facilities.",
    details: [
  ...
  },
  {
    ...
    description: "Twelve eco-designed apartment blocks (numbered 1–12) housing Eco Sphere's 2,000+ residents in energy-efficient, solar-powered, green-roofed living spaces.",
    details: [
      "12 apartment blocks",
      "2,000+ residents",
      "Solar-powered homes",
  ...
  },
  {
    ...
    description: "A peaceful multi-faith religious zone featuring a Hindu Temple, Church, Mosque, and Buddhist Temple — all designed with eco-friendly architecture and meditation gardens.",
    details: [
      "Hindu Temple",
      "Church",
      "Mosque",
...
function MapSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      className: "py-24 px-4 relative overflow-hidden",
      style: {
        background: "linear-gradient(135deg, oklch(0.07 0.04 200) 0%, oklch(0.10 0.05 220) 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto relative", ref, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 reveal", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "oklch(0.65 0.05 200)" },
                children: "Click any glowing hotspot to discover what makes each zone special."
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                HOTSPOTS.map((spot) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    title: spot.label,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative flex items-center justify-center", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "11px" }, children: spot.icon })
                          }
                        )
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal mt-8 flex flex-wrap justify-center gap-3", children: HOTSPOTS.map((spot) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: () => setActiveHotspot(activeHotspot === spot.id ? null : spot.id),
              ...
              style: {
                background: activeHotspot === spot.id ? `${spot.color}30` : "rgba(255,255,255,0.05)",
                border: `1px solid ${activeHotspot === spot.id ? spot.color : "rgba(255,255,255,0.12)"}`,
                color: activeHotspot === spot.id ? spot.color : "oklch(0.70 0.05 200)"
              },
              "data-ocid": `map.${spot.id}.toggle`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: spot.icon }),
                spot.label
              ]
            },
            spot.id
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        style: { color: "oklch(0.75 0.05 200)" },
                        children: activeInfo.description
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: activeInfo.details.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto relative", ref, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: FAQS.map((faq, i) => {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            style: {
                              background: isOpen ? "oklch(0.52 0.18 148)" : "oklch(0.52 0.18 148 / 0.12)",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "This website was built by a group of passionate students as part of a school sustainability project."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: CREATORS.map((creator) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-2", style: { color: "oklch(0.55 0.05 200)" }, children: "Building a Better World Since 2026" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm mb-6", style: { color: "oklch(0.45 0.05 200)" }, children: [
          "© ",
          year,
          " Eco Sphere. Building a Better World."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            style: { color: "oklch(0.45 0.05 200)" },
            children: "This is not a real city. This website was made as a school project."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "oklch(0.38 0.04 200)" }, children: [
          "Built with ❤️ using",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ApartmentsSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(EnergySection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ParksSection, {}),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CreatorsSection, {})
    ] }),
